...
// - Добавлены механики. Для каждого механика добавлен Enum, может ли он обслуживать только определенный тип авто, либо все авто. В соответствии с этим
//   при попытке провести техобслуживание либо ремонт, будет выдаваться соответствующее оповещение, может ли механик производить действия с конкретным авто.
//   При добавлении механиков к автомобилям будет также учитываться навык механика. То есть, если к автомобилю из класса Car добавить механика, который обслуживает только грузовики ONLY_TRUCK,
