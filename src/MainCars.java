...
public class MainCars {
    public static void main(String[] args) {
        ...
        drive(liaz, false,10.8, 180);  //переопределять для каждого класса не стал, так как не вижу смысла, информация выводится одинаковая для любого транпорта, независимо от его вида
